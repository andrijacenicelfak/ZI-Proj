...
namespace Algorithms
{
    ...
    class RC6
    {
        ...
        public void SetKey(string key)
        {
            ...
            /*
            int i0;
            for (i0 = 0; i0 < keychar.Length; i0++)
            {
                normkey[i0] = keychar[i0];
            }
            for (; i0 < normkey.Length; i0++)
            {
                normkey[i0] = (char)0;
            }*/
            ...
            for (i0 = 0; i0 < c; i0++)
            {
                L[i0] = 0;
                L[i0] = normkey[4 * i0];
                L[i0] = ROL(L[i0], 8) | normkey[4 * i0 + 1];
                L[i0] = ROL(L[i0], 8) | normkey[4 * i0 + 2];
                L[i0] = ROL(L[i0], 8) | normkey[4 * i0 + 3];
            }*/
        ...
        // Kriptovanje najvise 16 byte podataka,
        //to bi znacilo da moze samo string od 16 karaktera od jednom
        ...
        // Dekrpitovanje najvise 16 byte podataka,
        //to bi znacilo da moze samo string od 16 karaktera od jednom
